...
def save_model(model, full_path=None, base_path=None, base_name=None, evo=None, epoch=None, iter=None, max_to_keep=None):
...
def save_all(model, optim, scheduler=None, info_dict=None,
             full_path=None, base_path=None, base_name=None, evo=None, epoch=None, iter=None, max_to_keep=None):
...
def is_checkpoint(path, base_name=None):
    ...
    return os.path.isfile(path) and file.endswith(".pt") and (file.startswith(base_name) if base_name is not None else True)
...
class WeightsOnlySaver:
    ...
    def save(self, model=None, evo=None, epoch=None, iter=None):
        ...
        save_path = save_model(model=model, full_path=self.full_path, base_path=self.base_path,
                               base_name=self.base_name, evo=evo, epoch=epoch, iter=iter, max_to_keep=self.max_to_keep)
    ...
    def get_checkpoints(self, include_iter=False):
        ...
        if self.full_path is not None:
            ...
            checkpoints = get_checkpoints(path=self.base_path, base_name=self.base_name, include_iter=False)
...
class TrainStateSaver:
    def __init__(self, model=None, optim=None, scheduler=None, full_path=None, base_path=None, base_name=None, max_to_keep=None):
    ...
    def save(self, model=None, optim=None, scheduler=None, info_dict=None, evo=None, epoch=None, iter=None):
